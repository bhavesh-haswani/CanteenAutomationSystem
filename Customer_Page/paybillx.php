   ...
   <!--       <li><a style="text-decoration:none;" href="../../Signinout/logout.php">Log out</a></li>
    ...
    <span class="align-middle">
      <div class="row">
        ...
        //$run = mysqli_query($con, $qry); $rows = mysqli_fetch_array($run)
          ...
          <div style="background-color:#ffffff; padding:40px; border-style: solid; border-width: thin; box-shadow: 10px 10px 9px grey; "><!-- margin-right:40% -->
            <form method="POST" action="updateitems.php">
              <div class="form-group">
                ...
                <input type="string" class="form-control" id="id" aria-describedby="emailHelp" name="ItemID" value="<?php echo $row3['MenuItemID']; ?>">
              </div>
              <div class="form-group">
                <label for="Name">Item Name</label>
                <input type="string" class="form-control" id="Name" placeholder="Item Name" name="ItemName" value="<?php echo $row3['ItemName']; ?>">
              </div>
              <div class="form-group">
                <label for="Name">Item Name</label>
                <input type="string" class="form-control" id="Name" placeholder="Item Name" name="ItemName" value="<?php echo $row3['ItemName']; ?>">
              ...
              <div class="form-group">
                ...
                <input type="string" class="form-control" id="Price" placeholder="Price" name="Price" value="<?php echo $row3['amount']; ?>">
              </div>
