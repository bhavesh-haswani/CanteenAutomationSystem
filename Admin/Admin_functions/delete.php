...
<center>
<form method="POST" action="delete_dbc.php">
              <div class="form-group">
                  <label style="margin-top:5%;" for="exampleInputName"> Catgory ID</label>
                   <select style="width:300px; "   name="abc" class="custom-select" id="inputGroupSelect03" > <!-- height230px; -->
                  <option style="width:300px; "  selected>Choose...</option> <!-- height230px; -->
                  <?php
